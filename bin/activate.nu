...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/Users/iovannyarroyo/sei/servers/VideogameCollector'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/Users/iovannyarroyo/sei/servers/VideogameCollector/bin/deactivate.nu'
